...
impl Interrupts {
    pub fn set_higher_trap_handler(
        &mut self,
        higher_trap_handler: extern "C" fn(cause: u64) -> TrapReturnValues,
    ) {
        unsafe {
...
extern "C" fn trap_dispatch(cause: u64) -> TrapReturnValues {
...
mod test {
    ...
    fn arch_timer(ctx: &mut TestContext) {
        ...
        extern "C" fn test_trap_handler(cause: u64) -> TrapReturnValues {
